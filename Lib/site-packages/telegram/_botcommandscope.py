...
class BotCommandScope(TelegramObject):
    ...
    * :class:`telegram.BotCommandScopeChatMember`
    ...
    ALL_CHAT_ADMINISTRATORS: Final[
        str
    ] = constants.BotCommandScopeType.ALL_CHAT_ADMINISTRATORS
...
class BotCommandScopeAllChatAdministrators(BotCommandScope):
    ...
    def __init__(self, *, api_kwargs: Optional[JSONDict] = None):
        super().__init__(
            type=BotCommandScope.ALL_CHAT_ADMINISTRATORS, api_kwargs=api_kwargs
        )
        self._freeze()
...
class BotCommandScopeChat(BotCommandScope):
    ...
    def __init__(
        self, chat_id: Union[str, int], *, api_kwargs: Optional[JSONDict] = None
    ):
...
class BotCommandScopeChatAdministrators(BotCommandScope):
    ...
    def __init__(
        ...
        super().__init__(
            type=BotCommandScope.CHAT_ADMINISTRATORS, api_kwargs=api_kwargs
        )
        with self._unfrozen():
            self.chat_id: Union[str, int] = (
                chat_id
