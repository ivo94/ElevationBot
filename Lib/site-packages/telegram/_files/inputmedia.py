...
class InputMedia(TelegramObject):
    ...
    def __init__(
        ...
        *,
        ...
        self.media: Union[
            str, InputFile, Animation, Audio, Document, PhotoSize, Video
        ] = media
    ...
    def _parse_thumb_input(
        thumb: Optional[FileInput],
    ) -> Optional[Union[str, InputFile]]:
        # We use local_mode=True because we don't have access to the actual setting and want
        # things to work in local mode.
        return (
            parse_file_input(thumb, attach=True, local_mode=True)
        ...
        *,
        ...
        if isinstance(media, Animation):
            ...
            media = parse_file_input(
                media, filename=filename, attach=True, local_mode=True
            )

        thumbnail = warn_about_thumb_return_thumbnail(
        ...
        with self._unfrozen():
            self.thumbnail: Optional[Union[str, InputFile]] = self._parse_thumb_input(
                thumbnail
            )
...
class InputMediaPhoto(InputMedia):
    ...
    def __init__(
        ...
        *,
        ...
        # things to work in local mode.
        media = parse_file_input(
            media, PhotoSize, filename=filename, attach=True, local_mode=True
        )
        super().__init__(
...
class InputMediaDocument(InputMedia):
    ...
    def __init__(
        ...
        *,
        ...
        # things to work in local mode.
        media = parse_file_input(
            media, Document, filename=filename, attach=True, local_mode=True
        )
        ...
        with self._unfrozen():
            ...
            self.disable_content_type_detection: Optional[
                bool
