...
class InlineQueryResultLocation(InlineQueryResult):
    ...
    def __init__(
        ...
        *,
        ...
        # Required
        super().__init__(
            constants.InlineQueryResultType.LOCATION, id, api_kwargs=api_kwargs
        )
        with self._unfrozen():
            ...
            self.input_message_content: Optional[
                InputMessageContent
            ] = input_message_content
            self.thumbnail_url: Optional[
                str
            ] = warn_about_deprecated_arg_return_new_arg(
            ...
            self.thumbnail_height: Optional[
                int
            ] = warn_about_deprecated_arg_return_new_arg(
    ...
    .. versionadded:: 20.0
    """
    MIN_PROXIMITY_ALERT_RADIUS: Final[
        int
    ...
    .. versionadded:: 20.0
    """
    MAX_PROXIMITY_ALERT_RADIUS: Final[
        int
    ] = constants.LocationLimit.MAX_PROXIMITY_ALERT_RADIUS
